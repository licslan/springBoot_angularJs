...
;(function ( $, window, document, undefined ) {
 ...
 $.fn.dropdowns = function(parameters) {
  var
      $allModules    = $(this),
      $document      = $(document),
  ...
  $allModules
      .each(function(elementIndex) {
       var
           settings          = ( $.isPlainObject(parameters) )
               ? $.extend(true, {}, $.fn.dropdowns.settings, parameters)
               : $.extend({}, $.fn.dropdowns.settings),
 ...
 /* Templates */
 $.fn.dropdowns.settings.templates = {
